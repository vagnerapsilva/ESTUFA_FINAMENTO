...
//		HAL_GPIO_WritePin(I2C1_DC_GPIO_Port, I2C1_DC_Pin, GPIO_PIN_RESET); // command
//		ssd1306_I2C_Write(SSD1306_I2C_ADDR, 0x00, (command));
//	}
//
//	// Send data
//	void SSD1306_WRITEDATA(uint8_t data) {
//		HAL_GPIO_WritePin(I2C1_DC_GPIO_Port, I2C1_DC_Pin, GPIO_PIN_SET); // data
//		ssd1306_I2C_Write(SSD1306_I2C_ADDR, 0x40, (data));
//	}
	...
	void SSD1306_WRITEDATA(uint8_t* buffer, size_t buff_size) {
		...
		HAL_GPIO_WritePin(SSD1306_CS_Port, SSD1306_CS_Pin, GPIO_PIN_SET); I2C1_CS_Pin
	}
#else
...
uint8_t SSD1306_Init(void) {
	...
	ssd1306_Reset();
	//HAL_GPIO_WritePin(I2C1_CS_GPIO_Port, I2C1_CS_Pin, GPIO_PIN_RESET); // select OLED
	...
	//HAL_GPIO_WritePin(I2C1_CS_GPIO_Port, I2C1_CS_Pin, GPIO_PIN_SET); // un-select OLED
	/* Return OK */
	return 1;
}
...
void SSD1306_ShowGif(uint8_t n_frames, ...) {
	...
	for (int i = 0; i < n_frames; i++) {
		SSD1306_DrawBitmap(0, 0, va_arg(args, const unsigned char*), 128, 64,
				1);
		SSD1306_UpdateScreen();
		SSD1306_Clear();
	}
...
void SSD1306_Counter(uint8_t seconds) {
	...
	while (currentTime <= seconds) {
		snprintf(currentTimeString, sizeof(currentTimeString), "%d",
				currentTime);
		SSD1306_Clear();
		SSD1306_GotoXY(32, 0);
...
//		SSD1306_DrawBitmap(0, 2, Signal816, 16, 8, 1);
//		SSD1306_DrawBitmap(24, 2, Bluetooth88, 8, 8, 1);
//		SSD1306_DrawBitmap(40, 2, Msg816, 16, 8, 1);
//		SSD1306_DrawBitmap(64, 2, GPRS88, 8, 8, 1);
//		SSD1306_DrawBitmap(90, 2, Alarm88, 8, 8, 1);
//		SSD1306_DrawBitmap(112, 2, Bat816, 16, 8, 1);
